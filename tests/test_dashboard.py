...
class TestDashboard(BaseTestCase):
    ...
    def test_get_status_counts_global(self):
        ...
        counts = ClaimService.get_status_counts(department_ids=None)
    ...
    def test_get_dashboard_counts_filtered_by_department(self):
        ...
        counts = ClaimService.get_dashboard_counts(department_ids=[self.seeded_dept1_id])
    ...
    def test_get_dashboard_counts_empty_list_returns_zero(self):
        ...
        counts = ClaimService.get_dashboard_counts(department_ids=[])
    ...
    def test_get_department_dashboard_counts(self):
        ...
        per_dept = ClaimService.get_department_dashboard_counts([self.seeded_dept1_id, self.seeded_dept2_id])

        self.assertEqual(per_dept[self.seeded_dept1_id], {
            "total": 4,
            "pending": 2,
            "in_progress": 1,
            "resolved": 1,
        ...
        self.assertEqual(per_dept[self.seeded_dept2_id], {
            "total": 2,
            "pending": 1,
            "in_progress": 0,
            "resolved": 0,
