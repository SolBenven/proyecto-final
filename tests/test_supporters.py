...
class TestSupporters(BaseTestCase):
    ...
    def test_add_supporter_successfully(self):
        ...
        success, error = ClaimService.add_supporter(self.claim_id, self.supporter_id)
    ...
    def test_check_is_supporter(self):
        ...
        # Adherirse
        ClaimService.add_supporter(self.claim_id, self.supporter_id)

        # Verificar
        is_supporter = ClaimService.is_user_supporter(self.claim_id, self.supporter_id)
    ...
    def test_creator_cannot_be_supporter(self):
        ...
        success, error = ClaimService.add_supporter(self.claim_id, self.creator_id)
    ...
    def test_remove_supporter_successfully(self):
        ...
        # Quitar adhesión
        success, error = ClaimService.remove_supporter(self.claim_id, self.supporter_id)
    ...
    def test_verify_supporter_removed(self):
        ...
        ClaimService.add_supporter(self.claim_id, self.supporter_id)
        ClaimService.remove_supporter(self.claim_id, self.supporter_id)
    ...
    def test_add_supporter_to_nonexistent_claim(self):
        ...
        success, error = ClaimService.add_supporter(99999, self.supporter_id)
    ...
    def test_multiple_supporters_on_same_claim(self):
        ...
        # Ambos se adhieren
        ClaimService.add_supporter(self.claim_id, self.supporter_id)
        ClaimService.add_supporter(self.claim_id, supporter2.id)

        # Verificar que ambos están adheridos
        self.assertTrue(ClaimService.is_user_supporter(self.claim_id, self.supporter_id))
        self.assertTrue(ClaimService.is_user_supporter(self.claim_id, supporter2.id))
